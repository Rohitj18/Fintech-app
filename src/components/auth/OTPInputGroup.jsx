...
const OTPInputGroup = () => {
    ...
    //return child component
        return (
        <div>
            <div id='OTPInputGroup' className="flex gap-8" data-autosubmit="true">
                <OTPInput
                    id="input1"
...
const OTPInput = ({ id, previousId, nextId, value, onValueChange, handleSubmit }) => {
    ...
    return (
        <input
            ...
            onKeyUp={handleKeyUp}
            className="w-[6rem] h-[6rem] text-center text-5xl outline-none border-b-2 border-primary-blue"
        />
    );
};
