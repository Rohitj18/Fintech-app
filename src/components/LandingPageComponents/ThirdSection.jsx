...
const ThirdSection = () => {
  ...
  return (
    <div className="h-[80vh] w-[100%] pt-[3rem] ">
      <div className="w-11/12 h-[100%] mx-auto flex flex-col  items-center gap-10">
        ...
        <div className="flex flex-row justify-center items-center gap-10 mt-[2em]">

             <div data-aos="flip-left" className="flex flex-col  w-[40em] justify-center items-center gap-[2em] h-[29em] box-shadow rounded-lg">
               ...
               <p className="text-4xl font-semibold">Aadhaar Card</p>
                ...
                <p className="text-center text-3xl">Unlock seamless financial access with Aadhaar - India's universal biometric identity, powering secure and convenient transactions on our fintech platform.</p>
                <div className='nav-link text-3xl font-bold text-primary-blue mt-[2em]'>
             ...
             <div data-aos="flip-right" className="flex flex-col  w-[40em] justify-center items-center gap-5 h-[29em] box-shadow rounded-lg">
             ...
             <p className="text-4xl font-semibold"> Pan Card</p>
                ...
                <p className="text-center text-3xl">Elevate your financial journey with PAN card - Your key to legitimate and hassle-free financial transactions, now available through our fintech services.</p>
             ...
             <div data-aos="flip-right" className="flex flex-col  w-[40em] justify-center items-center gap-5 h-[29em] box-shadow rounded-lg">l
             <div className="flex flex-row justify-center items-center">
             <RiGovernmentFill/>
             <p className="text-4xl font-semibold"> Income Tax Returns</p>
             
             </div>
                <p className="text-center text-3xl">Take control of your financial future with hassle-free income tax returns - file, track, and secure your financial well-being with our user-friendly platform.</p>
                <div className='nav-link text-3xl font-bold text-primary-blue mt-[2em]'>
                    <NavLink data-id="1" style={{ textDecoration: 'none' }} to="https://incometaxindia.gov.in/Pages/tax-services/file-income-tax-return.aspx"  >Fill Form</NavLink>
                </div>
